...
import 'package:mygoals/app/widgets/icons.dart';
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            if (value == null || value.trim().isEmpty) {
                              return 'Please enter your task titile';
                            }
                            return null;
                          },
                        ),
                          ...
                          onPressed: () {
                            if (homeCtrl.formKey.currentState!.validate()) {
                              ...
                              var task = Task(
                                  ...
                                  color: color);
                              Get.back();
                              homeCtrl.addTask(task) ? EasyLoading.showSuccess('success') : EasyLoading.showError('Duplicated Task');
                            }
                          },
